...
//           <div className='w-1/3'>
//             <img src={gig.image} alt="" className="rounded-lg shadow-md" />
//           </div>
//           <div className='flex justify-between w-1/6 gap-2'>
//             <img src={gig.image} alt="" className="w-12 h-12 rounded" />
//             <img src={gig.image} alt="" className="w-12 h-12 rounded" />
//             <img src={gig.image} alt="" className="w-12 h-12 rounded" />
//           </div>
//         </div>
//         <div className='pr-20 pl-15 w-full'>
//           <h1 className='text-2xl font-bold tracking-wide leading-relaxed'>{gig.title}</h1>
