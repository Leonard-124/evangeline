...
//     <div>
//     <Header/>
//     <div className='mt-14 bg-[#dddddc88] w-full'>
...
//         <h1 className='absolute left-0 right-10 top-24 sm:top-36 md:top-52  ml-5 text-xl sm:text-2xl md:text-4xl lg:text-5xl font-bold leading-tight tracking-[-1.5px] text-[#f1f1f1f1]'>{items[3]?.title || ""}</h1>
//       </div>
//       <div className='hidden md:block md:w-[350px] lg:w-[400px] mb-10'>

//         <div className='w-[650px] mb-20'>{/* Side 1*/}
//           <div className='bg-[#6b6b6b] h-32 sm:h-40 md:h-48 lg:h-[250px] m-2 w-full'></div>
//         </div>

//         <div className='w-full bg-[#fefffa] p-3 sm:p-4 md:p-6 pb-20'>
//           <div className='flex flex-col gap-2 font-serif text-sm sm:text-base md:text-lg lg:text-xl'>
//           <h1 className='font-bold font-sans text-lg sm:text-xl md:text-2xl m-2'>
...
//           </p>
//           <h1 className=' font-bold text-lg sm:text-xl md:text-2xl m-2'>When Textiles Become Protest</h1>
//           <p>
  ...
  return (
    <div>
      ...
      <div className="mt-14 bg-[#dddddc88] w-full">
        ...
        <div className="w-full h-[250px] sm:h-[300px] md:h-[400px] lg:h-[450px] relative">
          <img
            src={items[3]?.image1 || "Default Image"}
            alt=""
            className="w-full h-full object-cover"
          />
          <h1 className="absolute left-0 right-10 top-24 sm:top-36 md:top-52 ml-4 text-xl sm:text-2xl md:text-4xl lg:text-5xl font-bold leading-tight tracking-[-1.5px] text-[#f1f1f1f1]">
            {items[3]?.title || ""}
          </h1>
        </div>
        ...
        <div className="flex flex-col md:flex-row justify-center">
          ...
          {/* Article body */}
          <div className="w-full bg-[#fefffa] p-2 sm:p-4 md:p-6 pb-20">
            <div className="flex flex-col gap-2 font-serif text-sm sm:text-base md:text-lg lg:text-xl">
              ...
              <p>
                This is where the kanga—Kitenge's close cousin—comes in. Unlike other African textiles,
                kangas carried actual words. Swahili proverbs, warnings, declarations, even shade—all
                printed right on the fabric. In the hierarchical social structures of East African Muslim communities,
                women were discouraged from speaking out of turn. Kangas became their workaround—a covert visual language
                that everyone understood but the colonizers couldn't police.
              </p>
              <p>
                And during Tanzania's independence movement in the 1960s, these textiles became revolutionary tools.
                The British had no idea they were looking at coded political messages. Women walked around wearing rebellion,
                and the oppressors just saw "pretty patterns." As Ziddi Msangi, a Tanzanian graphic designer, put it:
                "The fact that women were the population who primarily carried these messages out into the world is significant,
                and is a reminder that women are a key constituent in any liberation movement".
              </p>

              <h1 className="font-bold text-lg sm:text-xl md:text-2xl m-2">What the Patterns Actually Mean</h1>
              <p><span className="font-semibold">The Camel—</span> Represents coastal trade routes that connected East Africa to the Indian Ocean world...</p>
              <p><span className="font-semibold">The Key—Freedom.</span> Symbolized liberation during independence movements...</p>
              <p><span className="font-semibold">The Chain—</span> Represented slavery broken, reclaiming humanity...</p>

              <h1 className="font-bold text-lg sm:text-xl md:text-2xl m-2">A Language Hidden in Plain Sight</h1>
              <p>
                Kangas carried Swahili proverbs like "Mbona mmenuna?" ("Why are you sulking?"), "Hujui kitu" ("You don't know anything"),
                "Alaa Kumbe" ("Oh, I see"), and "Mama nipe radhi kuishi na watu kazi" ("Mother, give me your blessing; living with people is hard").
                These were chosen messages—sometimes tender, sometimes sharp, always meaningful.
              </p>

              <h1 className="font-bold text-lg sm:text-xl md:text-2xl m-2">Where Did This Fabric Even Come From?</h1>
              <p>
                European manufacturers developed printed cotton inspired by Indonesian batik techniques and brought it into West Africa.
                Dutch traders created Dutch Wax prints, which flopped in Indonesia but exploded in Africa. By the 1930s, African consumers
                influenced pattern development, embedding local stories and political events into designs.
              </p>

              <h1 className="font-bold text-lg sm:text-xl md:text-2xl m-2">The Kitenge Renaissance</h1>
              <p>
                The annual Kitenge Fashion Fest and Gala Awards in Eldoret has become East Africa’s biggest fashion event, with over 2,500 guests.
                Wearing Kitenge became a deliberate choice, a rejection of Western fashion dominance, and a declaration of African dignity.
              </p>

              <h1 className="font-bold text-lg sm:text-xl md:text-2xl m-2">The Fractal Legacy</h1>
              <p>
                Ron Eglash explains how fractal geometry permeates African fabrics. These motifs trace back to sand divination, geomancy,
                Boolean algebra, and ultimately the digital computer. Every circuit in the world has roots in Africa’s fractal legacy.
              </p>

              <h1 className="font-bold text-lg sm:text-xl md:text-2xl m-2">Wear History. Hang Rebellion.</h1>
              <p>
                We've taken framed Kitenge swatches—real fabric, real patterns—and paired each with a QR code. Scan it. Hear the history.
                These aren’t just textiles. They’re archives of resistance, voices of women who couldn’t speak but could wear their truth.
              </p>
              <p>Your grandmother knew it was powerful. Now you know why.</p>
            </div>
          </div>
